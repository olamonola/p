 ...
 */
@Entity
@Table(name = "student_view_role_date_unimportant")
public class StudentViewRoleDateUnimportant implements Serializable {

    private static final long serialVersionUID = -2363937782609248556L;
    ...
    public StudentViewRoleDateUnimportant() {
    }
