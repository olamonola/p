 ...
 * @author Ola
 */
public interface StudentViewRoleDateUnimportantRepository extends JpaRepository<StudentViewRoleDateUnimportant, Integer>{
   
    @Query(value = "SELECT s from StudentViewRoleDateUnimportant s"
    ...
    public Page<StudentViewRoleDateUnimportant> searchConfirmedOrNotConfirmed(
            Pageable pageable,
